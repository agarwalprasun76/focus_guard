...
from core_v2.coordinator.components.activity import ActivityMonitorComponent, WindowChangedEventData, IdleStateChangedEventData
...
class TestActivityComponentPytest:
    ...
    async def test_error_handling(self, component, activity_monitor):
    ...
    async def test_polling_loop(self, component, event_bus):
