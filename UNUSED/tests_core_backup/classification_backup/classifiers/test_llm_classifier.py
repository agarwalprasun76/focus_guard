"""
Tests for the LLM classifier adapter in core.
...
from focus_guard.core.classification.classifiers.llm import LLMClassifierAdapter
from core.domain_classifier.classifiers.llm_classifier import LLMDomainClassifier


class TestLLMClassifierAdapter(unittest.TestCase):
    """Tests for the LLMClassifierAdapter class."""
    
    def setUp(self):
        """Set up test fixtures.
        
        Creates a patch for the legacy LLM classifier and configures
        ...
        """
        # Create a patch for the legacy LLM classifier
        self.legacy_classifier_patcher = patch('core.classification.classifiers.llm.LLMDomainClassifier')
        self.mock_legacy_class = self.legacy_classifier_patcher.start()
        
        # Create a mock instance that will be returned when LLMDomainClassifier is instantiated
        ...
        self.adapter = LLMClassifierAdapter()
    ...
    def test_name_property(self):
        ...
        """
        self.assertEqual(self.adapter.name, "llm_classifier")
    
    def test_classify_returns_none(self):
        """Test that the basic classify method returns None.
        
        The LLM classifier requires context to classify content, so the basic
    ...
    def test_classify_with_context_useful_content(self):
        ...
        self.mock_legacy_instance.classify.return_value = {"classification": "useful", "confidence": 0.8, "reason": "Educational content"}
    ...
    def test_classify_with_context_distraction_content(self):
        ...
        # Configure the mock legacy classifier
        self.mock_legacy_instance.can_classify.return_value = True
        self.mock_legacy_instance.classify.return_value = {"classification": "distraction", "confidence": 0.8, "reason": "Entertainment content"}
    ...
    def test_classify_with_context_neutral_content(self):
        ...
        # Configure the mock legacy classifier
        self.mock_legacy_instance.can_classify.return_value = True
        self.mock_legacy_instance.classify.return_value = {"classification": "neutral", "confidence": 0.5, "reason": "Neutral content"}
    ...
    def tearDown(self):
        ...
        Stops the patch for the legacy LLM classifier to avoid affecting other tests.
        This ensures that the original LLMBaseClassifier class is restored
        after each test.
        """
