"""
Tests for the domain excluder blocking strategy in core_v2.
...
from core_v2.blocking.strategies.domain_excluder import DomainExcluderStrategy, HOSTS_CACHE_FILE, CACHE_TTL_DAYS
...
"""
        ...
        self.config_loader_patcher = patch('core_v2.blocking.strategies.domain_excluder.ConfigurationLoader')
...
"""
        ...
        with patch('requests.get', return_value=mock_response), \
             ...
             patch('pickle.dump'), \
             patch('core_v2.blocking.strategies.domain_excluder.is_valid_domain', return_value=True):
