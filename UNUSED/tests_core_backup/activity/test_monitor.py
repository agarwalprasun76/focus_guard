...
class TestActivityMonitor(unittest.TestCase):
    ...
    def test_browser_monitor_property(self):
        ...
        with patch("core_v2.activity.browser.tab_monitor.BrowserTabMonitor") as mock_browser_monitor_class:
    ...
    def test_get_active_window_browser(self):
        ...
        with patch("core_v2.activity.monitor.create_url_from_string") as mock_create_url:
            mock_url = MagicMock()
