...
defined in core_v2.activity.models.
"""
...
class TestWindowInfo(unittest.TestCase):
    ...
    def test_from_dict_with_url(self):
        ...
        with patch("core_v2.utils.domain_utils.create_url_from_string") as mock_create_url:
            mock_url = MagicMock()
...
class TestActivityEvent(unittest.TestCase):
    ...
    def test_from_dict_with_window_info(self):
        ...
        with patch("core_v2.activity.models.WindowInfo.from_dict") as mock_from_dict:
