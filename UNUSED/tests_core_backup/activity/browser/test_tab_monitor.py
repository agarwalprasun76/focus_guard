...
core_v2.activity.browser.tab_monitor.
"""
...
class TestBrowserTabMonitor(unittest.TestCase):
    ...
    def setUp(self):
        ...
        with patch("core_v2.activity.browser.tab_monitor.BrowserExtensionIntegration", 
    ...
    def test_extension_integration_property(self):
        ...
        with patch("core_v2.activity.browser.tab_monitor.BrowserExtensionIntegration") as mock_extension_class:
    ...
    def test_get_tabs_by_domain_no_domain_field(self):
        ...
        # Mock URL creation
        with patch("core_v2.activity.browser.tab_monitor.create_url_from_string") as mock_create_url:
