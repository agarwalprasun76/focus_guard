...
core_v2.activity.browser.extension_integration.
"""
...
class TestBrowserExtensionIntegration(unittest.TestCase):
    ...
    def setUp(self):
        ...
        with patch("core_v2.activity.browser.extension_integration.BrowserIntegration", 
    ...
    def test_browser_integration_property(self):
        ...
        with patch("core_v2.activity.browser.extension_integration.BrowserIntegration") as mock_browser_class:
    ...
    def test_fallback_get_active_tab(self):
        ...
        with patch("core_v2.activity.platform.get_platform_implementation") as mock_get_platform:
