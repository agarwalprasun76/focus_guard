"""
Tests for distraction alert handlers.

This module contains tests for the distraction alert handlers.
"""
...
class TestBlockingHandler(unittest.TestCase):
    ...
    def test_handle(self, mock_extract_domain):
        ...
        # Verify only the tab with matching domain was closed
