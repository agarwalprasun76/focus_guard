...
from core_v2.browser.interfaces import ExtensionManagerInterface
from core_v2.browser.models.browser import BrowserType
from core_v2.browser.extension.tab_server import get_tab_server
from core_v2.browser.extension.process_manager import get_tab_server_process_manager
...
class BrowserExtensionManager(ExtensionManagerInterface):
    ...
    def _get_default_extension_dir(self) -> str:
        ...
        # Use the new extension directory in core_v2
    ...
    def _install_edge_extension(self, browser_path: str) -> bool:
        ...
        try:
            # Edge can install extensions by launching with the --load-extension flag
            # This will open Edge with the extension loaded
            cmd = [browser_path, f"--load-extension={self._extension_dir}", "--no-first-run"]
