...
from core_v2.browser.extension.user_installation.ui import launch_installation_guide
...
def launch_guide_for_browser(browser_type: BrowserType, extension_dir: Optional[str] = None):
    ...
    """
    from core_v2.browser.extension.user_installation.guide import ExtensionInstallationGuide
