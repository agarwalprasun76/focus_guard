...
from core_v2.alert.models import AlertLevel
...
class AlertConfigManager:
    ...
    def get_platform_config(self, platform_name: str) -> Dict[str, Any]:
        ...
        """
        platform_config = self.config_manager.get_config_value(
            f"{AlertConfigKeys.ALERTS_ROOT}.{AlertConfigKeys.PLATFORM_ROOT}",
            {}
        )
    ...
    def set_provider_config(self, provider_name: str, config: Dict[str, Any]) -> None:
        ...
        Args:
            ...
            config: New provider configuration
        """
        providers_config = self.config_manager.get_config_value(
            AlertConfigKeys.ALERT_PROVIDERS_DEFAULT_CONFIG,
            {}
        )
    ...
    def is_provider_enabled(self, provider_name: str) -> bool:
        ...
        providers_enabled = self.config_manager.get_config_value(
            AlertConfigKeys.ALERT_PROVIDERS_ENABLED,
            {}
        )
        ...
        default_config = self.config_manager.get_config_value(
            AlertConfigKeys.ALERT_PROVIDERS_DEFAULT_CONFIG,
            {}
        )
    ...
    def get_alert_history_max_size(self) -> int:
        ...
        """
        size = self.config_manager.get_config_value(
            AlertConfigKeys.ALERT_HISTORY_MAX_SIZE,
            AlertConfigManager.DEFAULT_MAX_HISTORY_SIZE
        )
    ...
    def get_cooldown_period(self) -> int:
        ...
        value = self.config_manager.get_config_value(
            AlertConfigKeys.COOLDOWN_PERIOD,
            None
        )
        ...
        if value is None:
            value = self.config_manager.get_config_value(
                f"{AlertConfigKeys.ALERTS_ROOT}.{AlertConfigKeys.COOLDOWN_PERIOD}",
                AlertConfigManager.DEFAULT_COOLDOWN_PERIOD
            )
    ...
    def get_history_size(self) -> int:
        ...
        return self.config_manager.get_config_value(
            f"{AlertConfigKeys.ALERTS_ROOT}.{AlertConfigKeys.HISTORY_SIZE}",
            100
        )
    ...
    def get_history_file(self) -> str:
        ...
        """
        return self.config_manager.get_config_value(
            f"{AlertConfigKeys.ALERTS_ROOT}.history_file",
            None
        )
