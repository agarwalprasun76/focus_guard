...
class CategoryBlockerStrategy(BlockingStrategy):
    ...
    def __init__(self, config_loader: ConfigurationLoader):
        ...
        self._logger = logging.getLogger("core_v2.blocking.strategies.category_blocker")
    ...
    def should_block(self, domain: Domain) -> BlockingDecision:
        ...
        # Map Category enum to string category for comparison with blocked_categories
        category_str = None
