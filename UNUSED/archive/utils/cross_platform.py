...
# Initialize logger
logger = get_logger("utils.cross_platform")
...
def get_active_window_info() -> Optional[Dict[str, str]]:
    ...
    if sys.platform == "win32":
        try:
            ...
            logger.error(f"[Windows] get_active_window_info exception: {e}", exc_info=True)
            return None
        ...
        try:
            ...
            logger.error(f"[Linux] get_active_window_info exception: {e}", exc_info=True)
            return None
    else:
