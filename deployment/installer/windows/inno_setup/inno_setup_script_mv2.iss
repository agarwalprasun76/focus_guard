...
UninstallDisplayIcon={app}\focusguard_native_host.exe
OutputDir=output

[Files]
; Copy native messaging host executable
Source: "..\\..\\core\\browser_detection\\webExtension_mv2\\dist\\focusguard_native_host.exe"; DestDir: "{localappdata}\\FocusGuard"; Flags: ignoreversion

; Copy native messaging host manifest
Source: "..\\..\\installer\\win\\focusguard_host.json"; DestDir: "{localappdata}\\FocusGuard"; Flags: ignoreversion

; Copy web extension files
Source: "..\\..\\core\\browser_detection\\webExtension_mv2\\manifest.json"; DestDir: "{localappdata}\\FocusGuard\\ext"; Flags: ignoreversion
Source: "..\\..\\core\\browser_detection\\webExtension_mv2\\background.js"; DestDir: "{localappdata}\\FocusGuard\\ext"; Flags: ignoreversion
Source: "..\\..\\core\\browser_detection\\webExtension_mv2\\icons\\*"; DestDir: "{localappdata}\\FocusGuard\\ext\\icons"; Flags: ignoreversion recursesubdirs createallsubdirs
...
Root: HKCU; Subkey: "Software\\Google\\Chrome\\NativeMessagingHosts\\com.focusguard.native"; ValueType: string; ValueData: "{localappdata}\\FocusGuard\\focusguard_host.json"; Flags: uninsdeletevalue

; Edge Native Messaging host registration
Root: HKCU; Subkey: "Software\\Microsoft\\Edge\\NativeMessagingHosts\\com.focusguard.native"; ValueType: string; ValueData: "{localappdata}\\FocusGuard\\focusguard_host.json"; Flags: uninsdeletevalue
...
begin
  ...
  if IsProcessRunning('focusguard_native_host.exe') then
