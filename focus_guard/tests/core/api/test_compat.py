"""
Tests for the compatibility layer in core.

This module contains unit tests for the compatibility functions and classes
that ease the transition from the old core module to the new core module.
"""
...
from focus_guard.core.api.compat import (
    DomainCategory,
...
class TestCompatibilityLayer(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.api_patcher = patch('core.compat.api')
    ...
    def test_map_category_to_legacy(self):
        """Test mapping a core Category to a legacy DomainCategory."""
        # Test mapping from core Category to legacy DomainCategory
