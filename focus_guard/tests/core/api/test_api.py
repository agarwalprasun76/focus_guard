"""
Tests for the main API class in core.
...
from focus_guard.core.api import ClassifierBlockerAPI
...
class TestClassifierBlockerAPI(unittest.TestCase):
    ...
    @patch('focus_guard.core.config.loader.ConfigurationLoader')
    @patch('focus_guard.core.classification.base.ClassifierRegistry')
    @patch('focus_guard.core.blocking.strategies.registry.BlockingStrategyRegistry')
    @patch('focus_guard.core.blocking.pipeline.BlockingPipeline')
    @patch('focus_guard.core.classification.domain_classifier.StandardDomainClassifier')
    @patch('focus_guard.core.classification.classifiers.youtube.YouTubeClassifierAdapter')
    @patch('focus_guard.core.blocking.strategies.domain_excluder.DomainExcluderStrategy')
    @patch('focus_guard.core.blocking.strategies.category_blocker.CategoryBlockerStrategy')
