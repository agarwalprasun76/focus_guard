...
class TestIntegerConfigValue(unittest.TestCase):
    """Test cases for IntegerConfigValue."""
    
    def test_init(self):
        """Test initialization."""
        # Create an int value
        value = IntegerConfigValue("test", 42)
    ...
    def test_validation(self):
        ...
        value = IntegerConfigValue("test", 42, min_value=0, max_value=100)
        ...
        # Create an int value with custom validator for allowed values
        def allowed_values_validator(v):
            return (v in [0, 42, 100], f"Value must be one of [0, 42, 100]")
        
        value = IntegerConfigValue("test", 42, validators=[allowed_values_validator])
...
class TestBooleanConfigValue(unittest.TestCase):
    """Test cases for BooleanConfigValue."""
    
    def test_init(self):
        """Test initialization."""
        # Create a bool value
        value = BooleanConfigValue("test", True)
...
class TestListConfigValue(unittest.TestCase):
    ...
    def test_validation(self):
        ...
        def validate_item(item):
            is_valid = isinstance(item, int) and 0 <= item <= 10
            return (is_valid, f"Item must be an integer between 0 and 10")
...
class TestDictConfigValue(unittest.TestCase):
    ...
    def test_validation(self):
        """Test validation."""
        # Create a dict value with custom validator for required keys
        def required_keys_validator(d):
            required_keys = ["a"]
        ...
        value = DictConfigValue("test", {"a": 1, "b": 2}, validators=[required_keys_validator])
        ...
        def validate_key(key):
            is_valid = isinstance(key, str) and key.isalpha()
            return (is_valid, f"Key must be alphabetic string")
