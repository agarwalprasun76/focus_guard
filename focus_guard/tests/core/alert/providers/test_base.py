...
from focus_guard.core.alert.providers.base import AlertProvider, CompositeAlertProvider, ConditionalAlertProvider
...
class TestConditionalAlertProvider(unittest.TestCase):
    ...
    def test_level_condition(self):
        ...
        from focus_guard.core.alert.providers.base import ConditionalAlertProvider
