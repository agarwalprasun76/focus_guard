...
core.activity.platform.__init__.
"""
...
class TestPlatformFactory(unittest.TestCase):
    ...
    def test_get_platform_implementation_windows(self, mock_import_module):
        ...
        mock_import_module.side_effect = lambda module_name: {
            "core.activity.platform.windows": mock_windows_module,
        }[module_name]
        ...
        # Verify import order
        mock_import_module.assert_called_once_with("core.activity.platform.windows")
    ...
    def test_get_platform_implementation_linux(self, mock_import_module):
        ...
        mock_import_module.side_effect = lambda module_name: {
            "core.activity.platform.windows": mock_windows_module,
            "core.activity.platform.linux": mock_linux_module,
        }[module_name]
        ...
        # Verify import order
        mock_import_module.assert_any_call("core.activity.platform.windows")
        mock_import_module.assert_any_call("core.activity.platform.linux")
    ...
    def test_get_platform_implementation_macos(self, mock_import_module):
        ...
        mock_import_module.side_effect = lambda module_name: {
            "core.activity.platform.windows": mock_windows_module,
            "core.activity.platform.linux": mock_linux_module,
            "core.activity.platform.macos": mock_macos_module,
        }[module_name]
        ...
        mock_import_module.assert_any_call("core.activity.platform.windows")
        mock_import_module.assert_any_call("core.activity.platform.linux")
        mock_import_module.assert_any_call("core.activity.platform.macos")
    ...
    def test_get_platform_implementation_import_error(self, mock_import_module):
        ...
        mock_import_module.side_effect = lambda module_name: {
            "core.activity.platform.windows": mock_windows_module,
            "core.activity.platform.linux": ImportError("Module not found"),
        }[module_name] if module_name == "core.activity.platform.windows" else ImportError("Module not found")
