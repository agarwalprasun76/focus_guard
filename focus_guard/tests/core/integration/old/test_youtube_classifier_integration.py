"""
Integration tests for the YouTube classifier with the core API.

This module contains tests for the integration of the YouTube classifier adapter
with the classifier-blocker API in the core architecture.
"""
...
from focus_guard.core.classification.classifiers.youtube import YouTubeClassifierAdapter
from focus_guard.core.api import ClassifierBlockerAPI

# Local definition for tab information (used in place of core.blocking.models.TabInfo)
@dataclass
class TabInfo:
...
class TestYouTubeClassifierIntegration(unittest.TestCase):
    ...
    @patch('core.classification.classifiers.youtube.YouTubeClassifierAdapter._get_legacy_classifier')
