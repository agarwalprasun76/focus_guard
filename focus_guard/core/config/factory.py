...
from focus_guard.core.config.interfaces import ConfigurationManager, ConfigProvider, ConfigScope
...
from focus_guard.core.config.adapters.json_adapter import LegacyJsonConfigAdapter, CategoryMappingAdapter
from focus_guard.core.config.providers.parallel_provider import ParallelConfigProvider
from focus_guard.core.config.schema.domain_schema import (
    create_focus_guard_schema,
    create_domain_settings_schema,
    create_focus_rules_schema,
    create_user_preferences_schema
)
from focus_guard.core.config.models.domain_model import (
